Feature: Delete a sheet by object
  ...
  Scenario Outline: Delete a sheet
    Given creating a sheet with the name "<name>" into this.sheet
  ...
  Scenario: Delete a sheet from an empty Spreadsheet
    Given an empty Spreadsheet
    Given creating a sheet with the name "A" into this.sheet
    When the client deletes a sheet which corresponds with the object this.sheet

  Scenario: Delete a sheet and save it
    Given creating a sheet with the name "B" into this.sheet
    When the client deletes a sheet which corresponds with the object this.sheet
  ...
  Scenario: Delete a non-existent sheet
    Given creating a sheet with the name "garbagename" into this.sheet
    When the client deletes a sheet which corresponds with the object this.sheet
